class AddCachedVotesToLocations < ActiveRecord::Migration[5.0]
  def self.up
   ...
   add_column :locations, :cached_weighted_score, :integer, :default => 0
   add_column :locations, :cached_weighted_total, :integer, :default => 0
   add_column :locations, :cached_weighted_average, :float, :default => 0.0
   ...
   add_index  :locations, :cached_weighted_score
   add_index  :locations, :cached_weighted_total
   add_index  :locations, :cached_weighted_average
  ...
  def self.down
   ...
   remove_column :locations, :cached_weighted_score
   remove_column :locations, :cached_weighted_total
   remove_column :locations, :cached_weighted_average
  end
end
